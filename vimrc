...
if $TERM == "xterm-256color"
    ...
    Plugin 'vim-scripts/Railscasts-Theme-GUIand256color.git'
...
augroup clojure
    ...
    autocmd BufRead,BufNewFile *.cljc set filetype=clojure
...
let g:ctrlp_user_command = ['.git', 'cd %s && git ls-files -com --exclude-standard | sort -u'] 
